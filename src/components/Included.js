  ...
  return (
    <section className="px-5 mb-20 md:mb-[6.25rem] xl:mb-[7.1825rem]">
      <section className="mx-auto xl:max-w-[1380px]">
        ...
        <div className="mx-auto md:max-w-[590px] lg:max-w-[1120px] ">
          <div className="mb-9">
          ...
          <section className="flex flex-col lg:flex-row">
            <div
              className="relative xl:w-1/2 flex justify-end py-6 before:absolute before: before:border-academy-green before:border-l-[3px]
                after:absolute after:bottom-0 after:left-0 after:w-1/2 after:border-b-[3px] after:border-academy-green"
            >
              <Image src={included} alt="" />
            </div>
            <article className="md:mx-auto py-8 pr-6 md:pr-0 border border-academy-gold md:w-[610px] xl:w-1/2">
              <ul className="list-['—'] mb-8 ml-4 p-4">
